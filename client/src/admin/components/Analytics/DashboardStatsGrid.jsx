      ...
      <BoxWrapper>
        ...
        <div className="pl-4">
          ...
          <div className="flex items-center">
            <strong className="text-xl text-gray-700 font-semibold">{users}</strong>
          </div>
        </div>
      </BoxWrapper>
      <BoxWrapper>
        ...
        <div className="pl-4">
          ...
          <div className="flex items-center">
            <strong className="text-xl text-gray-700 font-semibold">{areas}</strong>
          </div>
        </div>
      </BoxWrapper>
      <BoxWrapper>
        ...
        <div className="pl-4">
          ...
          <div className="flex items-center">
            <strong className="text-xl text-gray-700 font-semibold">{cameras}</strong>
          </div>
        </div>
      </BoxWrapper>
    </div>
...
function BoxWrapper({ children }) {
  return <div className="bg-white rounded-sm p-4 flex-1 border border-gray-300 shadow-lg transform transition-transform duration-200 hover:scale-105 flex items-center">{children}</div>
}
